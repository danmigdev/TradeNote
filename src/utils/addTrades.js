...
export async function useImportTrades(param1, param2, param3, param0) {
    return new Promise(async (resolve, reject) => {
        ...
        let readAsTextArray = ["tradeZero", "template", "tdAmeritrade", "interactiveBrokers" , "tradovate", "ninjaTrader", "heldentrader", "rithmic", "fundTraders", "tastyTrade", "topstepX", "metaTrader4"]
        ...
        if (selectedBroker.value == "metaTrader4") {
            console.log(" -> MetaTrader 4")
            await useBrokerMetaTrader4(fileInput).catch(error => {
                importFileErrorFunction(error)
            })
        }
